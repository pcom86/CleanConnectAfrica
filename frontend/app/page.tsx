    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-20">
        <div className="max-w-3xl text-center">
          <span className="inline-block px-3 py-1 bg-brand-green-light text-brand-green text-sm font-medium rounded-full mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/login"
              className="px-8 py-4 bg-white text-gray-700 font-semibold rounded-xl border border-gray-200 hover:bg-gray-50 transition-colors text-lg"
            >
